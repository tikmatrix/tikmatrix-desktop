...
- **Skip posts count**: Number of posts to skip before processing (0–8). This allows you to skip the first few posts on a user's profile before starting to interact with their content. Only required when data source is "Usernames".
