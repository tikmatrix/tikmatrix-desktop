...
sidebar_position: 3
title: API-exempel
description: Kodexempel för användning av TikMatrix lokalt API
---

Den här sidan tillhandahåller kodexempel för användning av TikMatrix lokalt API på olika programmeringsspråk.
...
### Batch-skapa uppgifter för flera enheter
...
### Försök igen med misslyckade uppgifter automatiskt
