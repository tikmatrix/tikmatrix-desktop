...
- **脚本**：按 Group 运行，المعاملات与调度互不影响
...
6. **التكوينالمعاملات**：延迟、随机度、每设备独立代理  
7. **设置调度**：错峰启动、循环执行
...
- **共享المعاملات模板**：按任务النوع固化一份 JSON  
- **统一التغييرات窗口**：只在约定时间升级脚本/版本

---

## 📋 7. أمثلة蓝图（20 台设备 / 120–160 账号）
