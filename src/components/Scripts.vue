<template>
    ...
    <button v-if="isFeatureUnlocked('scrapeAdsCode')" class="btn btn-md btn-primary  ml-1 mb-1"
        @click="$emiter('showDialog', { name: 'scrapeAdsCode' })">
        <font-awesome-icon icon="fa-solid fa-spider" class="h-3 w-3 mr-1" />
        {{ $t('scrapeAdsCode') }}
    </button>
    <button class="btn btn-md btn-primary  ml-1 mb-1"
